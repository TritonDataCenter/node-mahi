...
function InactiveRoleError() {
    MahiError.call(this, {
        restCode: 'InactiveRole',
        statusCode: 403,
        message: 'None of your active roles give access ' +
            'to this resource, but another one of your roles may give access.'
    });
}
...
function RoleTagMismatchError() {
    MahiError.call(this, {
        ...
        statusCode: 403,
        message: 'None of your roles give access to this resource.'
    });
}
util.inherits(RoleTagMismatchError, MahiError);
